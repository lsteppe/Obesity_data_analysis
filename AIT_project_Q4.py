...
file_path = "/Users/laurensteppe/Desktop/Grad School/AIT 580/obesity_data.csv"
...
# Extract data only for Income and Obesity
...
filtered_df = selected_columns[selected_columns['Question'].str.contains('obesity|overweight', case=False, regex=True)]
